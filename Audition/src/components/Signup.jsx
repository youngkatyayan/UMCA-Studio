                        ...
                        <form>
                            ...
                            {otpSent && (
                                <div className="relative z-0 w-full mb-6 group">
                                    ...
                                    <button
                                        type="button"
                                        className="mt-4 border text-white px-4 py-2 bg-green-500 hover:bg-green-700 rounded"
                                        onClick={verifyOtp}
                                    >
                                        Verify OTP
                                    </button>
                            ...
                            {/* <div className='flex mt-2 justify-between items-center mb-5'>
                                <div className='flex  gap-1 sm:gap-2'>
                                    <p className='text-white text-[.8rem] sm:text-base whitespace-nowrap sm:font-semibold'>Don't have an account?</p>
                                    <Link className='text-green-700 text-[.8rem] sm:text-base whitespace-nowrap hover:underline' >Sign Up</Link>
                                </div>
                                
                                <div>
                                    <Link to={'/'} className='text-white sm:font-semibold hover:underline text-[.8rem] sm:text-base whitespace-nowrap'>Forget Password</Link>
                                </div>
                            </div> */}
